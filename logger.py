...
__all__ = ["log_state", "log_event", "set_start_time"] 
...
_start_time = datetime.now() # This is the initial value when the module loads

# Allows main.py to set the actual game start time
